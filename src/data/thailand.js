...
export const thailandBookings = [
  // ---- KOH SAMUI (Sep 1–5) ----
  {
    ...
    source: "Booking.com",
    leg: "samui",
    property: "Sea Valley Resort",
    area: "Lipa Noi, Koh Samui",
    status: "confirmed",
    checkIn: "2026-09-01", checkOut: "2026-09-05", nights: 4,
    room: "Superior Villa with Private Pool",
    ...
    breakdown: [
      ...
      ["VAT", "THB 1,091.69"],
      ["City tax", "THB 155.96"],
      ["Service charge", "THB 1,668.73"],
    ],
    freeCancelUntil: "2026-08-17T23:59:00",
    cancelTiers: [
      ["Until 17 Aug 11:59 PM", "THB 0 (free)"],
      ["From 18 Aug", "THB 9,256 (50%)"],
      ["From 2 Sep / no-show", "THB 18,512 (100%)"],
    ],
    payment: "Guaranteed by Visa ••1980. No prepayment; pay at property. 3% discount if paid cash (THB/USD/EUR).",
    phone: "+66 77 485 745",
  },
  {
    id: "2033975213",
    source: "Agoda",
    leg: "samui",
    property: "Mimosa Resort & Spa",
    area: "Maenam, Koh Samui",
    status: "overlap",
    checkIn: "2026-09-01", checkOut: "2026-09-05", nights: 4,
    room: "Jacuzzi Lover Deluxe",
    occupancy: "2 adults, 1 child (1 yr)",
    board: "Breakfast included",
    ...
    payment: "Pay later — auto-charged 16 Aug 2026 to Visa ••1980.",
    phone: "",
  },
  {
    id: "2033972495",
    source: "Agoda",
    leg: "samui",
    property: "Tolani Resort Koh Samui",
    area: "Choeng Mon, Koh Samui",
    status: "overlap",
    checkIn: "2026-09-01", checkOut: "2026-09-05", nights: 4,
    ...
    payment: "Pay later — auto-charged 29 Aug 2026 to Visa ••1980. (Priced in RMB.)",
    phone: "",
  },
  // ---- BANGKOK (Sep 5–8) ----
  {
    ...
    source: "Agoda",
    leg: "bangkok",
    property: "lebua at State Tower",
    area: "Silom, Bangkok",
    status: "overlap",
    checkIn: "2026-09-05", checkOut: "2026-09-08", nights: 3,
    room: "lebua Premium Suite River View",
    ...
    payment: "Pay later — auto-charged 1 Sep 2026 to Visa ••1980. Free BTS Saphan Taksin shuttle 07:00–17:00.",
    phone: "+66 2 624 9999",
  },
  {
    id: "2034357546",
    source: "Agoda",
    leg: "bangkok",
    property: "Avani+ Riverside Bangkok",
    area: "Thonburi (west bank), Bangkok",
    status: "overlap",
    checkIn: "2026-09-05", checkOut: "2026-09-08", nights: 3,
    room: "Skyline River View Room",
    occupancy: "2 adults",
    board: "Breakfast included",
    guest: "Mohammad Rezwanul Haque Rose",
    ...
    payment: "Pay later — auto-charged 2 Sep 2026 to Visa ••1980. Rooftop pool 06:00–20:00.",
    phone: "",
  },
  {
    id: "2034352678",
    source: "Agoda",
    leg: "bangkok",
    property: "Chatrium Hotel Riverside Bangkok",
    area: "Charoenkrung, Bangkok",
    status: "overlap",
    checkIn: "2026-09-05", checkOut: "2026-09-08", nights: 3,
    room: "Grand Deluxe King River View",
    occupancy: "3 adults",
    board: "Breakfast included",
    guest: "Mohammad Rezwanul Haque Rose",
    ...
    payment: "Pay later — auto-charged 19 Aug 2026 to Visa ••1980. (Priced in USD.)",
    phone: "+66 2 307 8888",
  },
  {
    id: "2034358886",
    source: "Agoda",
    leg: "bangkok",
    property: "Centre Point Plus Hotel Silom",
    area: "Silom / Charoenkrung, Bangkok",
    status: "overlap",
    checkIn: "2026-09-05", checkOut: "2026-09-08", nights: 3,
    room: "Deluxe Plus (apartment-style)",
    occupancy: "2 adults",
    board: "Breakfast included",
    guest: "Mohammad Rezwanul Haque Rose",
    ...
    payment: "Pay later — auto-charged 1 Sep 2026 to Visa ••1980. Cashback ~THB 845.",
    phone: "+66 2 266 0521",
  },
];
